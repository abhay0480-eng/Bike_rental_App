            ...
            <div className="p-5 w-full rounded text-center">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="rounded text-left">
                        <input className="px-3 py-3 w-full  border border-[#D1D5DB] bg-[#FFF7ED] outline-[#FF8C38]" type="email" name="email" value={formData.email} placeholder="Please enter your Email" onChange={handleInput} />
                        {error?.email && <div className="text-base text-red-400 my-1 ">{error?.email}</div>}
                        <input className="px-3 py-3 w-full border border-[#D1D5DB]  bg-[#FFF7ED] border-t outline-[#FF8C38]  border-t-[#D1D5DB] " type="password" name="password" value={formData.password} placeholder="Please enter your Password" onChange={handleInput} />
